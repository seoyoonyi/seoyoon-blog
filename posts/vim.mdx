...
---
category: "React"
title: "useMemo 로 생각해보는 메모이제이션 성능"
publishedAt: "2022-04-09"
image: /posts/career/job_2022/2022.jpg
summary: "모든 소스코드는 결국 메모리에 저장되는 과정을 거치게 되는데, 저장된 김에 ‘useMemo’ 를 이용하여 메모리에 저장된 데이터를 재활용하면 무조건 이득이 아닌가?"
---

![](/posts/career/job_2022/2022.jpg)
